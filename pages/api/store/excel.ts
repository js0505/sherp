        ...
        try {
            ...
            workbook.eachSheet(function (worksheet) {
                ...
                businessNumArr.forEach(async (businessNum, index) => {
                    ...
                    if (store) {
                        // 기존에 입력된 데이터가 있는지 확인
                        const findCreditCountIdx = store.creditCount.findIndex(
                            function (value) {
                                return (
                                    value.year === year &&
                                    value.month === parseMonth
                                )
                            }
                        )
...
const makeStoreReport = async ({ year, res }) => {
    const sheetColumns = [
        ...
        { header: "포스", key: "pos" },
        { header: "키오스크", key: "kiosk" },
        { header: "주방프린터", key: "printer" },
        { header: "단말기", key: "cat" },
        { header: "라우터", key: "router" },
    ]
        ...
        stores.forEach((item) => {
            ...
            const rowData = {
                ...
                jan_cms:
                    jan_valueIndex === -1
                        ? ""
                        : yearFilteredCount[jan_valueIndex].cms,
                feb_cms:
                    feb_valueIndex === -1
                        ? ""
                        : yearFilteredCount[feb_valueIndex].cms,
                mar_cms:
                    mar_valueIndex === -1
                        ? ""
                        : yearFilteredCount[mar_valueIndex].cms,
                apr_cms:
                    apr_valueIndex === -1
                        ? ""
                        : yearFilteredCount[apr_valueIndex].cms,
                may_cms:
                    may_valueIndex === -1
                        ? ""
                        : yearFilteredCount[may_valueIndex].cms,
                jun_cms:
                    jun_valueIndex === -1
                        ? ""
                        : yearFilteredCount[jun_valueIndex].cms,
                jul_cms:
                    jul_valueIndex === -1
                        ? ""
                        : yearFilteredCount[jul_valueIndex].cms,
                aug_cms:
                    aug_valueIndex === -1
                        ? ""
                        : yearFilteredCount[aug_valueIndex].cms,
                sep_cms:
                    sep_valueIndex === -1
                        ? ""
                        : yearFilteredCount[sep_valueIndex].cms,
                oct_cms:
                    oct_valueIndex === -1
                        ? ""
                        : yearFilteredCount[oct_valueIndex].cms,
                nov_cms:
                    nov_valueIndex === -1
                        ? ""
                        : yearFilteredCount[nov_valueIndex].cms,
                dec_cms:
                    dec_valueIndex === -1
                        ? ""
                        : yearFilteredCount[dec_valueIndex].cms,
                jan_count:
                    jan_valueIndex === -1
                        ? ""
                        : yearFilteredCount[jan_valueIndex].count,
                feb_count:
                    feb_valueIndex === -1
                        ? ""
                        : yearFilteredCount[feb_valueIndex].count,
                mar_count:
                    mar_valueIndex === -1
                        ? ""
                        : yearFilteredCount[mar_valueIndex].count,
                apr_count:
                    apr_valueIndex === -1
                        ? ""
                        : yearFilteredCount[apr_valueIndex].count,
                may_count:
                    may_valueIndex === -1
                        ? ""
                        : yearFilteredCount[may_valueIndex].count,
                jun_count:
                    jun_valueIndex === -1
                        ? ""
                        : yearFilteredCount[jun_valueIndex].count,
                jul_count:
                    jul_valueIndex === -1
                        ? ""
                        : yearFilteredCount[jul_valueIndex].count,
                aug_count:
                    aug_valueIndex === -1
                        ? ""
                        : yearFilteredCount[aug_valueIndex].count,
                sep_count:
                    sep_valueIndex === -1
                        ? ""
                        : yearFilteredCount[sep_valueIndex].count,
                oct_count:
                    oct_valueIndex === -1
                        ? ""
                        : yearFilteredCount[oct_valueIndex].count,
                nov_count:
                    nov_valueIndex === -1
                        ? ""
                        : yearFilteredCount[nov_valueIndex].count,
                dec_count:
                    dec_valueIndex === -1
                        ? ""
                        : yearFilteredCount[dec_valueIndex].count,
                pos: product ? (product.pos ? "O" : "X") : "",
                kiosk: product ? (product.kiosk ? "O" : "X") : "",
                printer: product ? (product.printer ? "O" : "X") : "",
                cat: product ? (product.cat ? "O" : "X") : "",
                router: product ? (product.router ? "O" : "X") : "",
            }
            try {
                switch (van) {
                    case "KIS":
